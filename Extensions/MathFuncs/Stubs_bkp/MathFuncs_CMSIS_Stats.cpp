...
{
    q15_t retVal = 0;
    arm_max_q15((q15_t*) param0.GetBuffer(), param0.GetSize(), &retVal, (uint32_t*) param1);
    return retVal;
}
...
{
    q15_t retVal = 0;
    arm_min_q15((q15_t*) param0.GetBuffer(), param0.GetSize(), &retVal, (uint32_t*) param1);
    return retVal;
}
...
{
    q15_t retVal = 0;
    arm_mean_q15((q15_t*) param0.GetBuffer(), param0.GetSize(), &retVal);
    return retVal;
}
...
{
    q15_t retVal = 0;
    arm_std_q15((q15_t*) param0.GetBuffer(), param0.GetSize(), &retVal);
    return retVal;
}
...
{
    q15_t retVal = 0;
    arm_var_q15((q15_t*) param0.GetBuffer(), param0.GetSize(), &retVal);
    return retVal;
}
